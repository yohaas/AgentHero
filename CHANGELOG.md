...
- Add a Windows release helper that rebuilds the setup EXE, keeps the manifest installer download link current, and makes in-app installed update downloads open the setup EXE.
